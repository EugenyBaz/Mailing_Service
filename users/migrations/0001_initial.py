    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone_number",
                    models.CharField(help_text="Введите номер телефона", max_length=50, verbose_name="Телефон"),
                ),
                ...
                (
                    "user_permissions",
                    models.ManyToManyField(blank=True, related_name="custom_users_permissions", to="auth.permission"),
                ),
            ],
            options={
